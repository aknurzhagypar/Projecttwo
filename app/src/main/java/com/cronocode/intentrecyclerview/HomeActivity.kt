...
class HomeActivity : AppCompatActivity() {
    ...
    private fun setupViewsMeal() {
        go_meal_fhome.setOnClickListener {
            val intent = Intent(this, RulesValueActivity::class.java)
            startActivity(intent)
        }
    }
    ...
    private fun GoProfilePage() {
        go_profile_page.setOnClickListener {
            val intent = Intent(this, ProfileMother::class.java)
            startActivity(intent)
        }
    }
